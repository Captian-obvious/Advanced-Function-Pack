...
function afp:scripts/explosive_arrow
...
function afp:scripts/compact_explosive_arrow
...
function afp:scripts/super_compact_explosive_arrow
...
function afp:scripts/compact_electric_arrow
execute if entity @e[type=arrow,nbt={Color:2842810}] run execute as @e[type=arrow,nbt={Color:2842810}] run data merge entity @s {pickup:1b,damage:20d,PierceLevel:2b}
function afp:scripts/super_compact_electric_arrow
