...
tellraw @a [{"text":"<","bold":false,"italic":false,"underlined":false},{"translate":"You","color":"green","bold":true,"italic":false,"underlined":false},{"text":"> ","color":"reset","bold":false,"italic":false,"underlined":false},{"translate":"No, I will DESTROY you!","color":"#980000","bold":false,"italic":false,"underlined":false}]
