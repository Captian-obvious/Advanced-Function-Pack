...
execute as @e[tag=Boss_Herobrine] if @e[tag=Boss_Herobrine] at @s store result bossbar herobrine_boss value run data get entity @s Health
execute as @e[tag=Boss_Herobrine] if @e[tag=Boss_Herobrine] at @s store result bossbar herobrine_boss max run attribute @s minecraft:generic.max_health base get
